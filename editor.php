				...
				<div id="story-display-box-body">
					<?php
						...
						if ($empty_sections > 0)
						{
							...
							echo "<form class='story-section-input-form' id='story-section-input-form' action='editor.php?id=$story_id' method='post'><input type='hidden' name='sectionOrder' value='$section_order'><button class='button-standard' type='submit'>Submit</button><div class='story-section-input-form-wordcount'>0/$section_length Words</div></form>";
